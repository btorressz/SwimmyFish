...
//  swimmyfish
//
//  Created by Brandon Torres on 5/14/19.
//  Copyright © 2019 Brandon Torres. All rights reserved.
//
...
extension GameScene{
    func createFish() -> SKSpriteNode {
        let fish = SKSpriteNode(texture: SKTextureAtlas(named:"player").textureNamed("fish1"))
        ...
        fish.physicsBody?.collisionBitMask = CollisionBitMask.pillarCategory | CollisionBitMask.groundCategory
        fish.physicsBody?.contactTestBitMask = CollisionBitMask.pillarCategory | CollisionBitMask.flowerCategory | CollisionBitMask.groundCategory
    ...
    func createWalls() -> SKNode  {
        ...
        flowerNode.physicsBody?.contactTestBitMask = CollisionBitMask.fishCategory
        ...
        topWall.physicsBody?.collisionBitMask = CollisionBitMask.fishCategory
        topWall.physicsBody?.contactTestBitMask = CollisionBitMask.fishCategory
        topWall.physicsBody?.isDynamic = false
        topWall.physicsBody?.affectedByGravity = false
        
        btmWall.physicsBody = SKPhysicsBody(rectangleOf: btmWall.size)
        btmWall.physicsBody?.categoryBitMask = CollisionBitMask.pillarCategory
        btmWall.physicsBody?.collisionBitMask = CollisionBitMask.fishCategory
        btmWall.physicsBody?.contactTestBitMask = CollisionBitMask.fishCategory
